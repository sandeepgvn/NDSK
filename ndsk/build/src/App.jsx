...
import LowVisionData from './LowVisionData'; // Import your Low Vision Data 
...
function App() {
    ...
    const [showLowVision, setLowVision] = useState(false);
                ...
                <div className="menu-item-container">
                    ...
                    <div className={`submenu ${hospitalAdminSubMenu ? 'active' : ''}`}>
                        ...
                        {/*<div className="submenu-item">Patient Registration</div>*/}
                            ...
                            <div className="submenu-item" onClick={toggleLowVision}>Low Vision</div>
                        ...
                        <div className="rop-form-panel">
                            <Router>
                                <Routes>
                                    ...
                                    <Route path="/chart" element={<PieChart data={data} />} />
                                </Routes>
                            </Router>
                        </div>
                    )}
